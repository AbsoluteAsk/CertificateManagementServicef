...
using ServiceConfiguration = Odyssey.DiagnosticCertificateService.SQS.Model.ServiceConfiguration;

namespace Odyssey.DiagnosticCertificateService.SQS.Helpers
{
